...
function BackgroundCircles({}: Props) {
  return (
    ...
    className='relative flex justify-center items-center'>
        <div className='absolute border border-[cyan] rounded-full h-[200px] w-[200px] mt-52 animate-ping'/>
        ...
        <div className='rounded-full border border-[cyan] h-[650px] w-[650px] absolute mt-52 opacity-20 animate-pulse'/>
